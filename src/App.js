      ...
      <>
        <BrowserRouter>
          <Routes>
            ...
            <Route
              path="/quizzes/attempt/:student_id/:quiz_id"
              element={<Attempt />}
            />
            <Route path="/Login/Home/:instructor_id" element={<Home />} />
            <Route
              path="/Login/Home/QuestionBank/:instructor_id"
              element={<Question />}
            />
            <Route
              path="/Login/Home/createquiz/:instructor_id"
              element={<Quiz />}
            />
            <Route
              path="/Login/Home/viewgrades/:instructor_id"
              element={<Grades />}
            />

            <Route
              path="/quizzes/attempt/review/:student_id/:quiz_id"
              element={<Review />}
            />
          </Routes>
        </BrowserRouter>
